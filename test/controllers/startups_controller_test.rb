...
class StartupsControllerTest < ActionController::TestCase
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post :create, startup: { about: @startup.about, days_at_ihub: @startup.days_at_ihub, employees: @startup.employees, founded: @startup.founded, name: @startup.name }
    end
  ...
  test "should update startup" do
    patch :update, id: @startup, startup: { about: @startup.about, days_at_ihub: @startup.days_at_ihub, employees: @startup.employees, founded: @startup.founded, name: @startup.name }
    assert_redirected_to startup_path(assigns(:startup))
  end
